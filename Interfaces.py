...
#Class for the Second Interface of the Game
class InterfaceGame:
    def __init__(self):
    ...
    def control(self):
        ...
        if(self.nb_iteration>10):
            ...
            if(t.check_occ(sais)):
                ...
                if(tab[0]==4):
                    self.canvas_back2.create_text(self.x+70,self.y,text="Essai "+str(self.nb_iteration)+": "+sais+" : "+str(tab[0])+"T, "+str(tab[1])+"V", font=("Times", "15" ,"bold italic"), fill="#0D0D0F")
...
#Function to move between the 2 Interfaces of the application
def move_page2():
